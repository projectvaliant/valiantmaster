...
let BattleMovedex = {
	...
	"cut": {
		...
		basePower: 70,
		category: "Physical",
		desc: "20% Chance to paralyze on hit.",
		shortDesc: "20% Chance to paralyze on hit.",
		id: "cut",
		name: "Cut",
		pp: 30,
		priority: 0,
	...
	"lusterpurge": {
		...
		basePower: 80,
		category: "Special",
		desc: "Has a 50% chance to lower the target's Special Defense by 1 stage. Higher chance to crit.",
	...
	"spark": {
		...
		basePower: 70,
		category: "Physical",
		desc: "Has a 40% chance to paralyze the target. Hits both enemies.",
	...
	"splash": {
		...
		basePower: 0,
		category: "Status",
		desc: "Causes the targets to become a Water type. Fails if the target is an Arceus or a Silvally.",
		shortDesc: "Changes both enemies typing to Water.",
		id: "splash",
		name: "Splash",
		pp: 20,
		priority: 0,
