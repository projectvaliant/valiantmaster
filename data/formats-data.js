...
let BattleFormatsData = {
	...
	nidoking: {
		randomBattleMoves: ["substitute", "fireblast", "icebeam", "earthpower", "sludgewave", "superpower", "earthquake", "thunderbolt"],
	...
	ninetalesalola: {
		randomBattleMoves: ["nastyplot", "blizzard", "moonblast", "substitute", "hiddenpowerfire", "freezedry", "auroraveil", "freezedry"],
	...
	venomoth: {
		randomBattleMoves: ["sleeppowder", "quiverdance", "bugbuzz", "sludgebomb", "substitute", "shadowball"],
	...
	golduck: {
		randomBattleMoves: ["hydropump", "scald", "icebeam", "psyshock", "encore", "calmmind", "substitute", "hiddenpowerelectric", "focusblast"],
	...
	vaporeon: {
		randomBattleMoves: ["wish", "protect", "scald", "roar", "icebeam", "healbell", "hiddenpowergrass", "shadowball", "acidarmor", "baby-dolleyes", "aquaring", "batonpass"],
	...
	flareon: {
		randomBattleMoves: ["flamecharge", "facade", "flareblitz", "superpower", "quickattack", "toxic", "protect", "wish"],
