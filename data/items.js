...
let BattleItems = {
	...
	"berserkberry": {
		...
		onEat(pokemon) {
			this.boost({atk: 1.5, spe: 1.5});
		},
		num: 700,
		gen: 7,
		desc: "Boosts Attack and Speed when less than 1/10 max health. Single use.",
	},
	"bigroot": {
		id: "bigroot",
		name: "Big Root",
	...
	"proteinpowder": {
		...
		num: 698,
		gen: 7,
		desc: "If held by a Ditto that hasn't Transformed, its Attack is 1.3X.",
	},
	"psychicgem": {
		id: "psychicgem",
		name: "Psychic Gem",
	...
	"smellingsalts": {
		...
		num: 699,
		gen: 7,
		desc: "If held by a Ditto that hasn't Transformed, its Special Attack is 1.3X.",
	},
	"snorliumz": {
		id: "snorliumz",
		name: "Snorlium Z",
